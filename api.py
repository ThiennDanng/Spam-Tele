...
def bot():
    for i in range(15):      
        ...
        threading.submit(shoppe)
        threading.submit(dongcre)
        threading.submit(homecre)
        threading.submit(call3)
        time.sleep(1)
        threading.submit(shinhan)
        threading.submit(medpro)
        threading.submit(vieon1)
        threading.submit(kingfood)        
        threading.submit(call1)
        time.sleep(1)
        threading.submit(meyyland)
        threading.submit(phongvu)
        threading.submit(phama)
        threading.submit(inc)
        threading.submit(call4)
        time.sleep(1)
        threading.submit(call)
        threading.submit(galaxy)
        threading.submit(callrs)
        threading.submit(appota)
        threading.submit(concung)
        time.sleep(1)
        threading.submit(call6)
        threading.submit(lotte)
        threading.submit(fahasa)
        threading.submit(ICANKID)
        threading.submit(ankhang)
        time.sleep(1)
        threading.submit(hasaki)
